                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border: 1px solid #eeeeee;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="font-size: 14px; background-color: #00A878; color: white; padding: 12px 8px; text-align: center; border-bottom: 1px solid #eeeeee;">Color</th>
                                            ...
                                            <tbody>
                                              @foreach($order->items as $lineItem)
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; padding: 12px 8px; text-align: center; border-bottom: 1px solid #eeeeee;">{{ $lineItem->selected_color }}</td>
                                                    <td style="font-size: 14px; padding: 12px 8px; text-align: center; border-bottom: 1px solid #eeeeee;">{{ $lineItem->selectedVariant && $lineItem->selectedVariant->value ? $lineItem->selectedVariant->value : 'No variant available' }}</td>
