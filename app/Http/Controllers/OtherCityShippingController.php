...
class OtherCityShippingController extends Controller
{
    protected OtherCityShippingServiceInterface $shippingService;

    public function __construct(OtherCityShippingServiceInterface $shippingService)
    {
        $this->shippingService = $shippingService;
    }

    public function list() {
        $list = OtherCityShipping::orderBy('created_at', 'desc')->simplePaginate(4);
