...
class StateShippingController extends Controller
{
    protected StateShippingServiceInterface $shippingService;

    public function __construct(StateShippingServiceInterface $shippingService)
    {
        $this->shippingService = $shippingService;
    }

    public function list() {
        $list = StateShipping::orderBy('created_at', 'desc')->simplePaginate(4);
