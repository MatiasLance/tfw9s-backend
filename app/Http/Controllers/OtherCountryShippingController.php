...
class OtherCountryShippingController extends Controller
{
    protected OtherCountryShippingServiceInterface $shippingService;

    public function __construct(OtherCountryShippingServiceInterface $shippingService)
    {
        $this->shippingService = $shippingService;
    }

    public function list() {
        $list = OtherCountryShipping::orderBy('created_at', 'desc')->simplePaginate(4);
