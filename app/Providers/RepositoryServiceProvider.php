...
use App\Modules\HomePageInformation\HomePageInformationService;
...
use App\Repository\Eloquent\HomePageInformationRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(HomePageInformationServiceInterface::class, HomePageInformationService::class);
        ...
        $this->app->bind(HomePageInformationRepositoryInterface::class, HomePageInformationRepository::class);
